/* AUTO-GENERATED from content/cpa-far/far-f4m3-batch-08.json by tools/json-to-js.js — DO NOT EDIT BY HAND.
   Edit the JSON, run `node tools/validate.js` then `node tools/json-to-js.js`, commit both.
   6 questions · schema aced-question-bank/v1 */
window.ACED_QUESTIONS = (window.ACED_QUESTIONS || []).concat(
[
 {
  "id": "cpa-far-f4m3-e68f08d6",
  "source": "F4.M3",
  "diff": "easy",
